    ...
    <footer className="bg-primary text-primary-foreground pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-primary-foreground/80 mb-4">
              Your gateway to thrilling adventures and unforgettable experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/adventures" className="text-primary-foreground/80 hover:text-white transition-colors">
                  Adventures
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-primary-foreground/80">Pokhara, Nepal</span>
              </li>
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-primary-foreground/80">info@thrillnepal.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-primary-foreground/20 mt-8 pt-6 text-center text-primary-foreground/60">
          <p>&copy; {new Date().getFullYear()} ThrillNepal. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
